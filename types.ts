...
// Mock Data until Firebase is connected
    ...
    history: [
       {
         ...
         doctor: "Dr. Martin",
         preparators: ["Dr Moussaoui Meriem"],
         preps: [
           { molecule: "Amoxicilline", status: "ok", type: 'tablet', tabs: "1.50", realDose: "37.50", gels: 20, capsule: "T4", duration: 10 },
         ]
       }
    ]
  },
    ...
    history: [
        {
         ...
         doctor: "Dr. House",
         preparators: ["Dr Hellali Djaafar Hamza"],
         preps: [
           { molecule: "Spironolactone", status: "ok", type: 'tablet', tabs: "0.50", realDose: "12.50", gels: 30, capsule: "T3", duration: 30 }
         ]
       }
    ]
  },
